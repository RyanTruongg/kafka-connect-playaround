...
@RestController
@RequestMapping("/api/jconsumer-kafka")
public class JconsumerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JconsumerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JconsumerKafkaResource(KafkaProperties kafkaProperties) {
